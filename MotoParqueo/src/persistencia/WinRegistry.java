...
public class WinRegistry {
  ...
  private static int user = WinRegistry.HKEY_CURRENT_USER;
  private static String regkey = "SOFTWARE\\Parqueadero\\Config";
  ...
  public static String leerConfig(String ambito, String llave){
	  try {
		return readString(user, regkey+"\\"+ambito, llave);
	} catch (IllegalArgumentException | IllegalAccessException | InvocationTargetException e) {
		e.printStackTrace();
		return null;
	}
  }
  public static boolean guardarConfig(String ambito, String llave, String valor){
	  try {
		writeStringValue(user, regkey+"\\"+ambito, llave, valor);
		return true;
	} catch (IllegalArgumentException | IllegalAccessException | InvocationTargetException e) {
		e.printStackTrace();
		return false;
